...
public class buttonFollowVisual : MonoBehaviour
{
    ...
    public GameObject toInstantiate = null;
    ...
    public void Follow(BaseInteractionEventArgs hover) {
        if(hover.interactorObject is XRPokeInteractor) {
            ...
            //Change state
            if (visualTarget.position.y < activationPressDepth.y && canChangeState) {
                //activated = !activated;
                canChangeState = false;
                //Instantiate(toInstantiate, instantiationTransform.position, instantiationTransform.rotation);
            }
        }
    }
